	...
	return (
		...
		<ScrollView>
			...
			<View>	
				...
				{appStore.routeBus.journey.schedules[route.params.scheduleIndex].timetables[route.params.timetableIndex].turns[route.params.turnIndex]?.eitherBuses?.map((allowedBus,index) => (
			...
			<View>	
				...
				{appStore.routeBus.returnJourney.schedules[route.params.scheduleIndex].timetables[route.params.timetableIndex].turns[route.params.turnIndex]?.eitherBuses?.map((allowedBus,index) => (
