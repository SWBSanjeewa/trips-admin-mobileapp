...
export class Product {
	...
	static centralParkApartment(): Product {
		return new Product(
			...
			[ProductOption.wifiOption(), ProductOption.tvOption(), ProductOption.parkingOption()],
		);
	}
}

export class ProductPrice {
	constructor(readonly value: number, readonly currency: string, readonly scale: string) {}
