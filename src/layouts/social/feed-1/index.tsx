...
const data: Training[] = [Training.basketball(), Training.running(), Training.workout()];
...
export default (): React.ReactElement => {
	...
	const renderItemFooter = (): React.ReactElement => (
		<View style={styles.itemFooter}>
			...
			<Button style={styles.itemAddButton} appearance="ghost" accessoryLeft={PlusIcon}>
				Add Training
			</Button>
		</View>
	);
	...
	const renderItem = (info: ListRenderItemInfo<Training>): React.ReactElement => (
		<Card style={styles.item} header={() => renderItemHeader(info)} footer={renderItemFooter}>
			<Layout style={styles.itemStyxContainer} level="2">
				...
				<Button style={styles.itemStyxButton} size="tiny" accessoryLeft={ClockIcon}>
					{`${info.item.styx} min`}
				</Button>
			</Layout>
