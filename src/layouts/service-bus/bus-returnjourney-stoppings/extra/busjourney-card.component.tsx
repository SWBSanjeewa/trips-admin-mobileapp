...
export const BusReturnJourneyCard = ({ navigation }): CardElement => {
	...
	if (appStore.bus.returnJourney.stoppings == null) {
			...
			<BottomSheet
					...
					<BottomSheetScrollView
					  ...
					  enableFooterMarginAdjustment={true}>
					 	<BusStoppingInfoCard stoppings={appStore.bus.returnJourney.stoppings} bottomSheetRef={bottomSheetRef} mapRef={mapRef}/>
					</BottomSheetScrollView>
				  </BottomSheet>
			)}	
