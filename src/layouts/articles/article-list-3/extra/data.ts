...
export class Article {
	...
	static howToEatHealthy(): Article {
		return new Article(
			...
			[Comment.byHubertFranck(), Comment.byHubertFranck(), Comment.byHubertFranck()],
		);
	}
...
export class Comment {
	...
	static byMarkVolter(): Comment {
		return new Comment("Thanks!", "Today 11:10 am", Profile.hubertFranck(), [], []);
	}
}
...
export class Profile {
	...
	static hubertFranck(): Profile {
		return new Profile("Hubert", "Franck", require("../assets/image-profile.jpg"));
	}
}
