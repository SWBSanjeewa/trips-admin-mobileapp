...
import ContentView from "../../layouts/route-bus/bus-journey-schedules-edit";
import { PlusOutlineIcon } from "../../components/icons";


export const RouteBusJourneySchedulesEditScreen = ({ navigation }): React.ReactElement => {
			...
			<TopNavigation title={props => (
				<RNText {...props} style={{fontWeight: "500", fontSize: 18}}>
					{route.params?.journeyType == "RouteBusReturnJourney" && (
						<>Return Journey Schedules Edit</>
					)}
					{route.params?.journeyType == "RouteBusJourney" && (
						<>Journey Schedules Edit</>
					)}
