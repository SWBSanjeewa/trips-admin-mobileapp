...
import ContentView from "../../layouts/route-bus/bus-allowed-buses-list";
import { PlusOutlineIcon } from "../../components/icons";


export const RouteBusAllowedBusesListScreen = ({ navigation }): React.ReactElement => {
