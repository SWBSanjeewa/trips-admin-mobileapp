...
import ContentView from "../../layouts/route-bus/bus-list";
import AppStore from "../../store/AppStore";
import { useStore } from "mobx-store-provider";
import { ArrowIosBackIcon } from "../../components/icons";
import { GooglePlacesAutocomplete } from 'react-native-google-places-autocomplete';

export const RouteTurnBusListScreen = ({ navigation }): React.ReactElement => {
	...
	const onBusAddPress = (): void => {
		...
		if(appStore.bus.routeType == "route"){
			...
			navigation && navigation.navigate("RouteTurnBusAdd");
		}else{
