...
export const Chat1Screen = ({ navigation }): React.ReactElement => {
	...
	const renderProfileAction = (): React.ReactElement => (
		<TopNavigationAction icon={renderProfileImage} onPress={onProfileActionPress} />
	);

	const renderProfileImage = (): React.ReactElement => (
		<Image style={styles.profileImage} source={require("../../assets/images/image-app-icon.png")} />
	);
