import { Button, Text, TextElement, Layout } from "@ui-kitten/components";
...
export const CardBody = (): TextElement => (
	<Text>
		A nebula is an interstellar cloud of dust, hydrogen, helium and other ionized gases. Originally,
