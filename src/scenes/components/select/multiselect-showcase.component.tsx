import { Select, SelectElement, SelectProps, SelectItem, SelectGroup } from "@ui-kitten/components";
...
export const MultiselectShowcase = (props: SelectCustomProps): SelectElement => {
	...
	return (
		<>
			<Select
				...
				style={styles.select}
			>
				{props.groupedOptions ? props.data.map(renderGroup) : props.data.map(renderOption)}
			</Select>
		</>
	);
};
