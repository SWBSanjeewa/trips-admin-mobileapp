...
export const ListItemShowcase = (props?: ListItemProps): ListItemElement => <ListItem {...props} />;
...
export const ListItemIconAccessoryShowcase = (props?: ListItemProps): ListItemElement => (
	<ListItem {...props} accessoryLeft={StarIcon} accessoryRight={style => AccessoryElement(style)} />
);
