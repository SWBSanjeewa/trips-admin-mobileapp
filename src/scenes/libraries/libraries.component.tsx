...
export const LibrariesScreen = ({ navigation }): React.ReactElement => {
	...
	const renderForwardIcon = (style): React.ReactElement => (
		<ArrowIosForwardIcon {...style} width="24" height="24" fill={theme["text-hint-color"]} />
	);
	...
	const renderHeader = (): React.ReactElement => (
		<React.Fragment>
			<Text style={styles.headerTitle} category="s2">
				This application is built with usage of tons Open Source community-driven libraries. This is
				our thanks to maintainers.
			</Text>
