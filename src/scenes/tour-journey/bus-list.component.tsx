...
import ContentView from "../../layouts/tour-bus/bus-list";
import AppStore from "../../store/AppStore";
import { useStore } from "mobx-store-provider";
import { ArrowIosBackIcon } from "../../components/icons";
import { GooglePlacesAutocomplete } from 'react-native-google-places-autocomplete';

export const TourBusListScreen = ({ navigation }): React.ReactElement => {
	...
	const onBusAddPress = (): void => {
		...
		console.log("appStore.bus.routeType>>"+appStore.bus.routeType);
		if(appStore.bus.routeType == "tour"){
			console.log("$$$$ RouteBusAdd "+appStore.bus.routeType);
			navigation && navigation.navigate("TourBusAdd");
		}else{
