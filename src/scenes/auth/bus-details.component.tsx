...
import ContentView from "../../layouts/service-bus/bus-details";


export const BusDetailsScreen = ({ navigation }): React.ReactElement => {
	...
	const onBackPress = () => {
		...
		navigation && navigation.navigate("BusHome", {reload: localreload});
	};
